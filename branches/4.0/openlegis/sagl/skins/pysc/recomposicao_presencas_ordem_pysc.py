...
if abrir:
    recomposicao = context.zsql.recomposicao_presencas_ordem_incluir_zsql(
    ...
    num_id_quorum = len(context.zsql.presenca_ordem_dia_obter_zsql(
        cod_sessao_plen=cod_sessao_plen,
        ind_excluido=0
    ))
    ...
    recomposicao =  context.zsql.recomposicao_presencas_ordem_atualizar_zsql(
