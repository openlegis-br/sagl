## Script (Python) "discussao_ordem_dia_pysc"
...
lista_discussao=context.zsql.discussao_ordem_dia_obter_zsql(cod_ordem=cod_ordem)
parlamentares=[]
...
if cod_parlamentar:
   for i in cod_parlamentar:
       if i not in parlamentares:
          context.zsql.discussao_ordem_dia_incluir_zsql(cod_ordem=cod_ordem,cod_parlamentar=i)
   for i in parlamentares:
       if i not in cod_parlamentar:
           context.zsql.discussao_ordem_dia_excluir_zsql(cod_ordem=cod_ordem,cod_parlamentar=i)
