...
parlamentares= []
for parlamentar in context.zsql.autores_obter_zsql(txt_dat_apresentacao=data_sessao):
    dic_parlamentar = {}
    dic_parlamentar['nom_parlamentar'] = str(parlamentar.nom_parlamentar)
    dic_parlamentar['cod_autor'] = int(parlamentar.cod_autor)
