...
def cabecalho(inf_basicas_dic,imagem):
    ...
    tmp_data+='\t\t\t\t<drawCentredString x="10.5cm" y="24.8cm">Relatório de Documentos Administrativos</drawCentredString>\n'
...
def principal(sessao,imagem,data,lst_documentos,dic_cabecalho,lst_rodape,dic_filtro={}):
    ...
    tmp_data+='\t<template pageSize="(21cm, 29.7cm)" title="Relatório de Documentos Administrativos" author="OpenLegis" allowSplitting="20">\n'
