...
if txt_texto.isspace() == False:
	...
	if norma_or_materia == 1:
		...
		lista_catalog = context.sagl.sagl_documentos.materia.Catalog(PrincipiaSearchSource=txt_texto)
		...
		#Chama o Catalog do Zope para realizar a busca textual no ZODB
		lista_catalog = context.sagl.sagl_documentos.norma_juridica.Catalog(PrincipiaSearchSource=txt_texto)
