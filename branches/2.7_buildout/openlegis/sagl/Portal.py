...
def manage_addSAGL(context, id, title='SAGL-Sistema Aberto de Gestão Legislativa', description='',
    ...
    if database == 'MySQL':
        site.manage_addProduct['ZMySQLDA'].manage_addZMySQLConnection(
            id='dbcon_openlegis',
            title='Banco de Dados do SAGL (MySQL)',
            use_unicode=True,
        ...
        site.manage_addProduct['ZPsycopgDA'].manage_addZPsycopgConnection(
            id='dbcon_openlegis',
            title='Banco de Dados do SAGL (PostgreSQL)',
