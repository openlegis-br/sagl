...
--
-- RELACIONAMENTOS PARA A TABELA `coautoria_proposicao`:
--   `cod_proposicao`
...
--
--  RELACIONAMENTOS PARA A TABELA `usuario`:
--   `cod_localidade_resid`
--       `localidade` -> `cod_localidade`
--
-- --------------------------------------------------------
...
--
--  RELACIONAMENTOS PARA A TABELA `usuario_unid_tram`:
--   `cod_unid_tramitacao`
--       `unidade_tramitacao` -> `cod_unid_tramitacao`
--   `cod_usuario`
--       `usuario` -> `cod_usuario`
