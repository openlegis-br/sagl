typeof navigator === "object" && (function () {
	...
	*/
	...
	var support = {
	  ...
	  // <input class="form-control" type="range"> Sliders
	  rangeInput: function () {
	...
	var controls = {
	  ...
	  // Create an <input class="form-control" type='range'>
	  ...
	  updateRangeFill: function updateRangeFill(target) {
	    ...
	    var range = is$2.event(target) ? target.target : target; // Needs to be a valid <input class="form-control" type='range'>
	...
	function () {
	  ...
	  _createClass(Listeners, [{
	    ...
	    value: function controls$1() {
	      ...
	      // Super weird iOS bug where after you interact with an <input class="form-control" type="range">,
	      ...
	      }); // Polyfill for lower fill in <input class="form-control" type="range"> for webkit
