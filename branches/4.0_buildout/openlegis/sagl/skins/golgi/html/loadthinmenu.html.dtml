<div class="ui visible left vertical labeled icon uncover sidebar menu no-border very thin sidemenu thinside">
    ...
    <div class="ui dropdown item">
        ...
        <div class="menu">
            ...
            <a class="item" href="photoeditor.html">
                Photo Editor
            </a>
    ...
    <div class="ui dropdown item">
        ...
        <div class="menu">
            ...
            <a class="item" href="animatedicon.html">
                Animated Icon
            </a>
