...
;(function(window) {
	...
	// grid items:
	var items = [].slice.call(document.querySelectorAll('.animicon'));

	function init() {
		/* Icon 1 */
		var el1 = items[0].querySelector('button.icobutton'), el1span = el1.querySelector('i');
		new Animocon(el1, {
			tweens : [
				// burst animation
				new mojs.Burst({
		...
		/* Icon 2 */
		var el2 = items[1].querySelector('button.icobutton'), el2span = el2.querySelector('i');
		new Animocon(el2, {
			tweens : [
				// burst animation
				new mojs.Burst({
		...
		/* Icon 3 */
		var el3 = items[2].querySelector('button.icobutton'), el3span = el3.querySelector('i');
		new Animocon(el3, {
			tweens : [
				// burst animation
				new mojs.Burst({
		...
		/* Icon 4 */
		var el4 = items[3].querySelector('button.icobutton'), el4span = el4.querySelector('i');
		...
		/* Icon 5 */
		var el5 = items[4].querySelector('button.icobutton'), el5span = el5.querySelector('i');
		...
		/* Icon 6 */
		var el6 = items[5].querySelector('button.icobutton'), el6span = el6.querySelector('i');
		...
		/* Icon 7 */
		var el7 = items[6].querySelector('button.icobutton'), el7span = el7.querySelector('i');
		new Animocon(el7, {
			tweens : [
				// burst animation
				new mojs.Burst({
		...
		/* Icon 8 */
		var el8 = items[7].querySelector('button.icobutton'), el8span = el8.querySelector('i');
		...
		/* Icon 9 */
		var el9 = items[8].querySelector('button.icobutton'), el9span = el9.querySelector('i');
		...
		/* Icon 10 */
		var el10 = items[9].querySelector('button.icobutton'), el10span = el10.querySelector('i'), el10counter = el10.querySelector('span.icobutton__text');
		...
		/* Icon 11 */
		var el11 = items[10].querySelector('button.icobutton'), el11span = el11.querySelector('i');
		...
		/* Icon 12 */ 
		var el12 = items[11].querySelector('button.icobutton'), el12span = el12.querySelector('i');
		...
		/* Icon 13 */
		var el13 = items[12].querySelector('button.icobutton'), el13span = el13.querySelector('i');
		new Animocon(el13, {
			tweens : [
				// burst animation
				new mojs.Burst({
		...
		/* Icon 14 */
		var el14 = items[13].querySelector('button.icobutton'), el14span = el14.querySelector('i'), el14counter = el14.querySelector('span.icobutton__text');
		new Animocon(el14, {
			tweens : [
				// ring animation
				new mojs.Transit({
		...
		/* Icon 15 */
		var el15 = items[14].querySelector('button.icobutton'), el15span = el15.querySelector('i');
		...
		/* Icon 16 */
		var el16 = items[15].querySelector('button.icobutton'), el16span = el16.querySelector('i');
