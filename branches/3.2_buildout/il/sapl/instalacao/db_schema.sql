...
(1, 'PL', 'Projeto de Lei', NULL, 0, 1, 0),
(2, 'PR', 'Projeto de Resolução', NULL, 0, 1, 0),
(3, 'REQ', 'Requerimento', NULL, 0, 1, 0),
(4, 'REC', 'Recurso', NULL, 0, 1, 0),
(5, 'PLC', 'Projeto de Lei Complementar', NULL, 0, 1, 0),
(6, 'PDL', 'Projeto de Decreto Legislativo', NULL, 0, 1, 0),
(7, 'MOC', 'Moção', NULL, 0, 1, 0),
(8, 'IND', 'Indicação', NULL, 0, 1, 0),
(9, 'PEL', 'Proposta de Emenda à Lei Orgânica', NULL, 0, 1, 0),
(10, 'VET', 'Veto', NULL, 0, 1, 0);
...
(2, NULL, 2, NULL, 1, NULL, NULL, 0, NULL, 0),
(3, NULL, 3, NULL, 1, NULL, NULL, 0, NULL, 0),
(4, NULL, 4, NULL, 1, NULL, NULL, 0, NULL, 0),
(5, NULL, 5, NULL, 1, NULL, NULL, 0, NULL, 0),
(6, NULL, 6, NULL, 1, NULL, NULL, 0, NULL, 0),
(7, NULL, 7, NULL, 1, NULL, NULL, 0, NULL, 0),
(8, NULL, 8, NULL, 1, NULL, NULL, 0, NULL, 0);
