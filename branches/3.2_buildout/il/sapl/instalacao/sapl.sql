-- Generation Time: 26-Ago-2017 às 11:17
...
ALTER TABLE `documento_administrativo`
  ADD PRIMARY KEY (`cod_documento`),
  ADD KEY `idx_num_ano` (`num_documento`,`ano_documento`),
  ADD KEY `idx_dat_documento` (`dat_documento`),
...
ALTER TABLE `materia_legislativa`
  ...
  ADD KEY `idx_matleg_ident` (`ind_excluido`,`tip_id_basica`,`ano_ident_basica`,`num_ident_basica`),
  ADD KEY `tip_id_basica` (`tip_id_basica`),
...
--
ALTER TABLE `tipo_instituicao`
  MODIFY `tip_instituicao` tinyint(4) NOT NULL AUTO_INCREMENT;
--
